// Modified version of Unity's UI default shader that scrolls another texture along the main texture. Used for scene transition controller

Shader "UI/TextureScroller"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                color *= ((tex2D(_MainTex, IN.mainTexcoord) + _TextureSampleAdd) * IN.color);
